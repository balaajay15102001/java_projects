...
//        Map<String,Student> students=new HashMap<>();
        ...
        students.add(new Student("003","Jeevi",547, 90.4f));
        ...
        for (Student student : students) {
            ...
            if(roll.equals(student.getRoll_no())){
                ...
                if(student.getCuttoff()>=90){
                    System.out.println("     -----Your assign Clg is:   \"Anna University\"-----");
                    System.out.println();
                    break;
                }
                else if (student.getCuttoff()>=80 && student.getCuttoff()<90) {
                    System.out.println("---Your assign Clg is:   \"Rathinam Technical Campus\"---");
                    System.out.println();
                    break;

                }
                else{
                    System.out.println("     -----Your assign Clg is:   \"PSG College\"-----");
                    System.out.println();
                    break;
